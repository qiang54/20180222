				...
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product_info.htm">
							<img src="${pageContext.request.contextPath}/products/hao/middle01.jpg" width="500px" height="200px" style="display: inline-block;">
						</a>
					</div>
				...
				<c:forEach items="${newList }" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/product?method=getProdById&pid=${p.pid}">
							<img src="${pageContext.request.contextPath}/${p.pimage}" width="130" height="120" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath }/product?method=getProdById&pid=${p.pid}" style='color:#666'>${fn:substring(p.pname,0,10)}...</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotList }" var="p">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/product?method=getProdById&pid=${p.pid}">
								<img src="${pageContext.request.contextPath}/${p.pimage}" width="120" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/product?method=getProdById&pid=${p.pid}" style='color:#666'>${fn:substring(p.pname,0,10)}...</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${p.shop_price }</font></p>
						</div>
